...
INSERT INTO `palavras_chave` VALUES ('17','Capacitação de professores'),('17','Ensino'),('17','Formação de professores'),('17','Geogebra'),('17','Tecnologias na Educação'),('20012013','horas'),('20012013','ponto'),('20012013','presença'),('2013CPPG01','Heurísticas'),('2013CPPG01','Metaheurísticas'),('2013CPPG01','Otimização combinatória'),('2013CPPG01','Redes eixo-raio'),('2015CPPG01','Consciência ambiental'),('2015CPPG01','Construct2'),('2015CPPG01','Disseminação cultural'),('2015CPPG01','Game Maker'),('2015CPPG01','Jogo digital'),('2015CPPG01','Sabará'),('2015CPPG02','Dijkstra'),('2015CPPG02','Ford-Moore-Bellman'),('2015CPPG02','Heurísticas'),('2015CPPG02','Sabará'),('2015CPPG02','Teoria de Grafos'),('2015CPPG02','Turismo'),('2015CPPG03','Modelo SAIR'),('2015CPPG03','Sistema de Equações Diferenciais'),('2015CPPG03','Vírus de computador'),('2015CPPG04','Instrumentação'),('2015CPPG04','Mineração de dados'),('2015CPPG04','Prevenção de Incêndio'),('2015CPPG05','Guarda Municipal'),('2015CPPG05','Sistema de Gerenciamento'),('2015CPPG05','Sistema WEB'),('2016CPPG02','Consumidor'),('2016CPPG02','Opiniões'),('2016CPPG02','Satisfação'),('2016CPPG03','Circuitos Integrados'),('2016CPPG03','Eletrônica Digital'),('2016CPPG03','Estado Lógico'),('30012013','Crawler'),('30012013','Popularidade'),('30012013','YouTube'),('7','Digital'),('7','Idoso.'),('7','Inclusão'),('7','Informática'),('7','Social'),('7','Tecnologia');
